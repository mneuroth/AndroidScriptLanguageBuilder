...
cmake -DCMAKE_TOOLCHAIN_FILE=$ANDROID_NDK_HOME/build/cmake/android.toolchain.cmake -DANDROID_ABI=$4 -DINSTALL_DOCUMENTATION=OFF -DSWIPL_PACKAGES=ON -DUSE_GMP=OFF -DSWIPL_SHARED_LIB=OFF -DSWIPL_PACKAGES_BDB=OFF -DSWIPL_PACKAGES_ODBC=OFF -DSWIPL_PACKAGES_QT=OFF -DSWIPL_PACKAGES_X=OFF ..
#ninja 
